const q3Data = {
    strategies: {
        ...
        openings: [
            { title: "1. 用时间(time)开头", example: "那是一个___________的（下午/雨天/周末），我永远记得______发生的那一刻，它让学会了______的道理。", case: "例句：那是一个放学后的雨天，我永远记得好友明文对我大叫的那一刻，它让我学会了不要冲动的道理。" },
            { title: "2. 用对比(comparison)开头", example: "我以前总觉得______（错误的想法），直到那次______（事件），才真正懂得了______（正确的想法）。", case: "例句：我以前总觉得朋友之间不用道歉，直到那次和小明吵架吵了两天，才真正懂得了友情也要两个人努力维系。" },
            { title: "3. 用场景(scene)开头", example: "（动作/物品）还静静地躺在（地点），我看着它，______（事件画面）又浮现在眼前。", case: "例句：那张皱巴巴的试卷还静静地躺在抽屉里，我看着它，数学老师失望的表情又浮现在眼前。" },
            { title: "4. 用环境(environment)开头", example: "（时间）的（地点）总是______（氛围），但那天，______（异常事件）打破了平静。", case: "例句：我们一家人的饭桌总是热闹的，但那天，弟弟愤怒的大喊大叫打破了平静。" },
            { title: "5. 用对话(dialogue)开头", example: "“（突然的话语/声响）”我转过头，看到（人物/场景），接下来，______（事件开端）……", case: "例句：“有人抢劫啊！”我转过头，看到一位阿姨正指着一名迅速跑走的黑衣男人，接下来，我做了一个让自己都惊讶的决定……" },
            { title: "6. 用题目(question)开头", example: "把题目中的“你”全部换成“我”，抄完题目后，加上一句“事情是这样发生的……”", case: "例句：把“你是一个做事有计划和有条理的人...”变成“我是一个做事有计划和有条理的人... 事情是这样发生的……”" }
        ],
        conclusions: [
