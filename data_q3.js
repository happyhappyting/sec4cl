// Q3 记叙文完整数据库 (包含写作技巧、性格、情绪、常用词)
const q3Data = {
    // 1. 写作技巧与模板
    strategies: {
        examTips: "用到所有的关键词！不要想太久，可以写一个很普通的故事，但是一定要写完。最后记得写感想。",
        openings: [
            { title: "1. 用时间(time)开头", example: "那是一个___________的（下午/雨天/周末），我永远记得______（事件关键词）发生的那一刻，它让我学会了______的道理（简单道理）。" },
            { title: "2. 用对比(comparison)开头", example: "我以前总觉得______（错误的想法），直到那次______（事件），才真正懂得了______（正确的想法）。" },
            { title: "3. 用场景(scene)开头", example: "（动作/物品）还静静地躺在（地点），我看着它，______（事件画面）又浮现在眼前。" },
            { title: "4. 用环境(environment)开头", example: "（时间）的（地点）总是______（氛围），但那天，______（异常事件）打破了平静。" },
            { title: "5. 用对话(dialogue)开头", example: "“（突然的话语/声响）”我转过头，看到（人物/场景），接下来，______（事件开端）……" },
            { title: "6. 用题目(question)开头", example: "把题目中的“你”全部换成“我”，抄完题目后，加上一句“事情是这样发生的……”" }
        ],
        conclusions: [
            ...
            { title: "4. 解决问题", content: "从那以后，我学会了有事好好说的道理。遇到冲突，我会想办法解决它。不管有什么事情，最后都会有好的结果。" },
            { title: "5. 团队合作", content: "其实，每个人都有自己的长处。找出自己的优点，好好利用，互相配合，就能交一份满分的答卷。" }
        ]
    },
    ...
    // 3. 情绪表达 (Emotions & Descriptive Sentences)
    emotions: [
        ...
        { word: "气得满脸通红", pinyin: "qì dé mǎn liǎn tōng hóng", meaning: "So angry that one's face turns red" },
        { word: "笑得见牙不见眼", pinyin: "xiào dé jiàn yá bù jiàn yǎn", meaning: "Laughing so hard eyes are squeezed shut" },
        ...
        { word: "心急如焚", pinyin: "xīn jí rú fén", meaning: "Burning with anxiety" },
